...
public class CarEquipment extends JFrame implements ChangeListener, ActionListener{
    ...
    public CarEquipment(){
        ...
        i1 = new JCheckBox("Vehicle Lift");
        i1.addActionListener(this);
        i2 = new JCheckBox("Air Compressor");
        i2.addActionListener(this);
        i3 = new JCheckBox("Jack stands");
        i3.addActionListener(this);
        i4 = new JCheckBox("Battery charger");
        i4.addActionListener(this);
        i5 = new JCheckBox("Engine hoist");
        i5.addActionListener(this);
        i6 = new JCheckBox("Hand Tools SET");
        i6.addActionListener(this);
        i7 = new JCheckBox("Impact wrench");
        i7.addActionListener(this);
        i8 = new JCheckBox("Ratchet and Socket Set");
    ...
    public void select(ActionEvent e){
        int day = s.getValue();
        final String[] equipment = {"Vehicle Lift, ","Air Compressor, ","Jack stands, ","Battery charger, ",
        "Engine hoist, ","Hand Tools SET, ","Impact wrench, ","Ratchet and Socket Set, "};
        final int[] prices = {1500, 1000, 750, 500, 500, 750, 1250, 800};
        int total = 0;
        String eq = "\n";
        for(int i = 0; i < items.length; i++) {
